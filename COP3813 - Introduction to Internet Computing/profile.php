  ...
  <body>
	...
	<div id="acct_container">
        ...
        <?php 
          ...
          <input type="text" id="usrname" name="usrname" value="<?php echo $info['usrname']; ?>">
          ...
          <input type="password" id="usrpass" name="usrpass"><br><br>
          <label for="usrrole">User Role</label><br>
          <select width="200px" type="text" id="usrrole" name="usrrole">
          ...
          <button type="submit" class="btn btn-default">      Update Profile      </button></form>
        </div>
			</div>	
	</div>
		<!-- Footer -->
