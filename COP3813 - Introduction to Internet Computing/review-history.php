  ...
  <body>
	...
	<div id="acct_container">
        ...
        <?php
          ...
          $data = mysql_query("SELECT * FROM meetings WHERE tstudent LIKE '%{$_COOKIE[$cookie_name]}%' AND reviewcomplete = 1 ORDER BY timestamp DESC") or die(mysql_error());
          ...
          {
            Print "<th>Class Id</th>" . "<th>Reviewer</th>" . "<th width=\"70%\">Review</th>" . "<th width=\"15%\">Availabilty and Price</th>" . "<th width=\"15%\">Knowledge</th>";
            while($info = mysql_fetch_array( $data )) 
            { 
               $id = $info['meetingid'];
               Print "<tr><td>".$info['classid'] . " </td>";
               Print "<td>".$info['istudent'] . "</td>"; 
               Print "<td>".$info['reviewarea'] . " </td>"; ?>
               <td>
               <div class="progress">
               <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="3" style="width: <?php echo $info['punctuality'] * 20; ?>%;"></div>
               </div>
              </td>
              <td>
               <div class="progress">
               <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="3" style="width: <?php echo $info['knowledge'] * 20; ?>%;"></div>
               </div>
              </td></tr>
              <?php
            } 
