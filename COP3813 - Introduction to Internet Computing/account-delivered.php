  ...
  <body>
	...
	<div id="acct_container">
        ...
        <form class="composeform" action="account-sentmail.php" method="post">
          ...
          echo "</select><br><br>"; 
          ?>
          <label for="message">Message</label><br><textarea rows="15" cols="50" type="text" id="message" name="message" required></textarea><br>
          <button type="submit" class="btn btn-default">      Sent      </button></form> <h4> Message Sent </h4>
        </div>
			</div>	
	</div>
		<!-- Footer -->
