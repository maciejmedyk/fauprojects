  ...
  <body>
	...
	<div id="acct_container">
        ...
        <form class="composeform" action="listing-post.php" method="post">
          ...
          $data = mysql_query("SELECT * FROM listings ORDER BY classid") or die(mysql_error()); 
          ...
          <button type="submit" class="btn btn-default">      Post Listing      </button></form> <h4> Listing Posted </h4>
        </div>
			</div>	
	</div>
		<!-- Footer -->
