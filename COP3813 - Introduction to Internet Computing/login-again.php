		...
		<div id="reg_container">
			<div class="leftside">
				<form class="inputform" action="login-submit.php" method="post">
					...
					<br><p>You Entered Invalid Credentials</p><br>
				</form>
			</div>
			<div class="rightside">
				<form class="inputform" action="login-register.php" method="post">
					...
					<label for="username">Retype Number Below Without Spaces</label><br>
