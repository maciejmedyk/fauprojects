		...
		<div id="reg_container">
			...
			<div class="rightside">
				<form class="inputform" action="login-register.php" method="post" onSubmit = "verifyForm()">
					...
					<label for="fullname">Full Name</label><br><input class="form-control" type="text" id="fullname" name="usrname" ><br>
					<label for="usernamereg">Email</label><br><input class="form-control" type="email" id="usernamereg" name="usrlogin" >
					<p>You Need To Register With FAU Email</p><br>
					<label for="passwordreg">Password</label><br><input class="form-control" type="password" id="passwordreg" name="usrpass" ><br>
					<label for="username">Role</label><br><select class="form-control" id="role" name="usrrole" >
